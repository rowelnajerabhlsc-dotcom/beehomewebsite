...
<section class="products-section">
    <div class="products-container">
        ...
        <!-- ================= NON MEMBERS ================= -->
        <h2 class="section-title">Available for Non-Members</h2>
        ...
        <!-- ================= MEMBERS ONLY ================= -->
        <h2 class="section-title">Exclusive to Members Only</h2>
        ...
        <div class="products-row">
            ...
            <div class="product-box">
                ...
                <p>• BHLIP 3%</p>
                <div class="product-buttons">
                    <a href="<?php echo isset($_SESSION['user_id']) ? '../HTML/credit.php' : '../HTML/needlogin.php'; ?>" class="btn-green">
                        View More
                    </a>
            ...
            <div class="product-box">
                ...
                <br><br><br>
                <div class="product-buttons">
                    <a href="<?php echo isset($_SESSION['user_id']) ? '../HTML/retail.php' : '../HTML/needlogin.php'; ?>" class="btn-green">
                        View More
                    </a>
            ...
            <div class="product-box">
                ...
                <br><br><br><br>
                <div class="product-buttons">
                    <a href="<?php echo isset($_SESSION['user_id']) ? '../HTML/bills.php' : '../HTML/needlogin.php'; ?>" class="btn-green">
                        View More
                    </a>
