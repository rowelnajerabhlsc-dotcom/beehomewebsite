   ...
   <section id="history">
        ...
        <section class="about-section">
            ...
            <div class="about-row">
                <div class="about-text">
                <p style = "font-size: 20px; text-align: justify;">
                    The Bee Home Labor Multipurpose Cooperative logo reflects the humble beginnings and strong foundation of the organization.
                    Inspired by the hardworking nature of bees, it symbolizes diligence, teamwork, and shared responsibility. Just as bees work
                    together in a hive, the founders developed discipline, cooperation, and commitment while striving toward common goals.
                    <br>
                    <br>
                    The circular design represents unity and equality among members, emphasizing that everyone plays a vital role in the 
                    cooperative’s growth. Its interconnected elements highlight collaboration and collective progress, similar to the 
                    structure of a thriving hive. The name “Bee Home” represents the cooperative as a second home—a supportive environment
    ...
    <section id="awards">
        ...
        <section class="awards-section">
            <div class="awards-container">
                ...
                <!-- CENTERED HEADER -->
                <h2 class="awards-bottom-title">OUR AWARDS AND RECOGNITION'S FOR THE PAST YEARS</h2>
                ...
                <div class="awards-description">
                    ...
                    <ul>
                        <li>Feeding Program for the ARAL Beneficiaries of Muzon Elementary School / November 12, 2025</li>
    ...
    <section id="officers">
        ...
        <section class="officers">
            <div class="officers-container">
                ...
                <img src="../IMAGES/team-img6.png" alt="Officers Image 6">
            </div>
        </section>
    </section>
