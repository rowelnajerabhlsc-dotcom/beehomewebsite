    ...
    <div id="privacyModal" class="modal-overlay">
        ...
        <div class="modal-box">
            ...
            <div class="modal-content">
                ...
                <p>
                    We are committed to protecting the confidentiality, integrity, and security of the information
                    collected through this website. Any Company information provided by users shall be treated as
                    confidential and shall be collected, processed, stored, and used only for legitimate business
                    purposes and in accordance with applicable data privacy and data protection laws.
                </p>

                <p>
                    By submitting information through this website, users consent to the collection and processing of
                    their personal data for purposes including, but not limited to, responding to inquiries, providing
                    requested services, improving website functionality, communicating relevant updates, and complying
                    with legal and regulatory requirements.
                </p>

                <p>
                    We implement reasonable safeguards to protect personal data against unauthorized access, alteration,
                    or misuse.
                </p>
