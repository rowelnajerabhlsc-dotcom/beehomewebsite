        ...
        <section class="services">
            <div class="services-container">
                <p class="services-desc">
                    Bee Home Labor Multipurpose Cooperative is dedicated to assisting its members in increasing their
        ...
        <section class="about">
            <div class="about-container">
                ...
                <p style="font-size: 22px; text-align: justify;">
                    ...
                    provide quality
                    labor and manpower services across various industries. Guided by cooperative principles and values,
                    we aim to uplift
                    our members’ socio-economic well-being while delivering efficient and reliable manpower solutions to
                    our clients.
                </p>

                <p style="font-size: 22px; text-align: justify;">
                    We take pride in being more than a manpower agency, we are a partner in productivity and community
                    development.
